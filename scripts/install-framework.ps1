...
Copy-Item (Join-Path $sourceRoot "starter\\artifacts\\current\\TaskBoard.current.md") (Join-Path $targetCurrentRoot "TaskBoard.current.md") -Force
Copy-Item (Join-Path $sourceRoot "starter\\artifacts\\tasks\\README.md") (Join-Path $targetTasksRoot "README.md") -Force
